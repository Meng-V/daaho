...
export const CAROUSEL = [
    {
        ...
        caption:
            "Woo Chong Yung 吳仲熊 (1898–1989), Landscape, 1970, hanging scroll, ink on paper, Cincinnati Art Museum, C.Y. Woo Collection, donated by T.H. Wu, 2015.324",
    },
    {
        name: "public launch",
        imageSrc: PublicLaunch,
        imageAlt:
        ...
        caption:
            "Dr. Hongmei Li discusses the \"Significance of the Project\" during the Public Launch event introducing the mission of addressing the invisibility of Asian American history in U.S. curricula.",
    },
    {
        name: "Japanese American",
        imageSrc: JapaneseAmerican,
        imageAlt:
        ...
        caption:
            "A 1944 letter from the National Japanese American Student Relocation Council to Miami University President A. H. Upham advocates for the inclusion of Japanese American students in scientific and technical programs. Courtesy of the Walter Havighurst Special Collections & University Archives. Miami University, Oxford, Ohio.",
    },
];
