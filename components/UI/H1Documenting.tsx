...
function H1Documenting({
    ...
    return (
        <>
            <h1 className={clsx(`mx-auto max-w-3xl font-display text-6xl text-center font-medium tracking-tight text-gray-700 sm:text-7xl`, className)}>
                Documenting{' '}
                <span className="relative whitespace-nowrap text-red-700">
                    ...
                    <span className="relative">Asian American</span>
                </span>{' '}
                Histories in Ohio
            </h1>

            <p className="mx-auto max-w-7xl mb-8 sm:mb-18 text-lg md:text-center text-slate-700">
